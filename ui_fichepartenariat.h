...
public:
    ...
    {
        fichePartenariat->setWindowTitle(QApplication::translate("fichePartenariat", "Dialog"));
        label_partenaire->setText(QApplication::translate("fichePartenariat", "Partenaire "));
        label_dateDebut->setText(QApplication::translate("fichePartenariat", "Date debut "));
        label_duree->setText(QApplication::translate("fichePartenariat", "Duree"));
        label_type->setText(QApplication::translate("fichePartenariat", "Type"));
        label_anneeReconduction->setText(QApplication::translate("fichePartenariat", "Annee reconduction "));
        lineEdit_anneeReconduction->setText(QString());
        label_description->setText(QApplication::translate("fichePartenariat", "Description "));
        label_commentaire->setText(QApplication::translate("fichePartenariat", "Commentaire "));
        label_poc->setText(QApplication::translate("fichePartenariat", "POC  "));
        lineEdit_poc->setText(QString());
        label_realisations->setText(QApplication::translate("fichePartenariat", "Realisations "));
        lineEdit_pays->setText(QString());
        label_pays->setText(QApplication::translate("fichePartenariat", "Pays"));
        pushButton_supprimerPartenariat->setText(QApplication::translate("fichePartenariat", "Supprimer"));
        pushButton_sauvegarderPartenariat->setText(QApplication::translate("fichePartenariat", "Sauvegarder"));
        pushButton_bloquedPartenariat->setText(QApplication::translate("fichePartenariat", "Debloquer"));
