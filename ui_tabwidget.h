...
"}"));
    ...
    {
        TabWidget->setWindowTitle(QApplication::translate("TabWidget", "TabWidget"));
        checkBox_pays->setText(QApplication::translate("TabWidget", "Recherche par pays"));
        checkBox_duree->setText(QApplication::translate("TabWidget", "Recherche par duree"));
        checkBox_ecole->setText(QApplication::translate("TabWidget", "Recherche par ecole"));
        checkBox_classe->setText(QApplication::translate("TabWidget", "Recherche par classe"));
        pushButton_newMobilite->setText(QApplication::translate("TabWidget", "Nouvelle Mobilite"));
        label_rechercheEleve->setText(QApplication::translate("TabWidget", "Rechercher un \303\251l\303\250ve :"));
        pushButton_statistiquesMobilite->setText(QApplication::translate("TabWidget", "Statistiques"));
        pushButton_actualiserMobilite->setText(QApplication::translate("TabWidget", "Actualiser"));
        label_filtreRechercheMobilite->setText(QApplication::translate("TabWidget", "Filtre recherche"));
        TabWidget->setTabText(TabWidget->indexOf(MOBILITE), QApplication::translate("TabWidget", "Mobilite"));
        pushButton_newPartenariat->setText(QApplication::translate("TabWidget", "Nouvelle partenariat"));
        pushButton_actualiserPartenariat->setText(QApplication::translate("TabWidget", "Actualiser"));
        label_recherchePartenariat->setText(QApplication::translate("TabWidget", "Rechercher un partenaire :"));
        pushButton_notificationPartenariat->setText(QString());
        checkBox_partenariatType->setText(QApplication::translate("TabWidget", "Recherche par type"));
        checkBox_partenariatPays->setText(QApplication::translate("TabWidget", "Recherche par pays"));
        checkBox_partenariatAnnee->setText(QApplication::translate("TabWidget", "Recherche par annee"));
        checkBox_partenariatPoc->setText(QApplication::translate("TabWidget", "Recherche par poc"));
        label_etatPartenariat->setText(QString());
        label_etatPartenariatColor->setText(QString());
        label_filtreRecherchePartenariat->setText(QApplication::translate("TabWidget", "Filtre recherche"));
        label_optionsPartenariat->setText(QApplication::translate("TabWidget", "Options"));
        checkBox_affichagePartenariatNonActif->setText(QApplication::translate("TabWidget", "Afficher les partenariats non-actif"));
        checkBox_affiachagePartenariatNonActifMois->setText(QApplication::translate("TabWidget", "Afficher les partenariats qui ne sont plus actif dans "));
        label_moisAffichage->setText(QApplication::translate("TabWidget", "mois"));
        TabWidget->setTabText(TabWidget->indexOf(PARTENRIAT), QApplication::translate("TabWidget", "Partenariat"));
        pushButton_newPOC->setText(QApplication::translate("TabWidget", "Nouveau POC"));
        pushButton_actualiserPOC->setText(QApplication::translate("TabWidget", "Actualiser"));
        label_recherchePOC->setText(QApplication::translate("TabWidget", "Rechercher un POC  :"));
        checkBox_pocFax->setText(QApplication::translate("TabWidget", "Recherche par fax"));
        checkBox_pocInstitution->setText(QApplication::translate("TabWidget", "Recherche par institution"));
        label_filtreRecherchePartenariat_2->setText(QApplication::translate("TabWidget", "Filtre recherche"));
        checkBox_pocFonction->setText(QApplication::translate("TabWidget", "Recherche par fonction"));
        checkBox_pocTelephone->setText(QApplication::translate("TabWidget", "Recherche par telephone"));
        TabWidget->setTabText(TabWidget->indexOf(POC), QApplication::translate("TabWidget", "POC"));
        pushButton_actualiserInstitution->setText(QApplication::translate("TabWidget", "Actualiser"));
        label_rechercheInstitution->setText(QApplication::translate("TabWidget", "Rechercher une Institution : "));
        pushButton_newInstitution->setText(QApplication::translate("TabWidget", "Nouvelle Institution"));
        checkBox_institutionPays->setText(QApplication::translate("TabWidget", "Recherche par pays"));
        label_filtreRechercheInstitution->setText(QApplication::translate("TabWidget", "Filtre recherche"));
        TabWidget->setTabText(TabWidget->indexOf(Institution), QApplication::translate("TabWidget", "Institution"));
    } // retranslateUi
