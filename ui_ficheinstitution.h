...
public:
    ...
    {
        ficheInstitution->setWindowTitle(QApplication::translate("ficheInstitution", "Dialog"));
        label_nom->setText(QApplication::translate("ficheInstitution", "Nom :"));
        label_pays->setText(QApplication::translate("ficheInstitution", "Pays  :"));
        pushButton_supprimerInstitution->setText(QApplication::translate("ficheInstitution", "Supprimer"));
        pushButton_bloquedInstitution->setText(QApplication::translate("ficheInstitution", "Debloquer"));
        pushButton_sauvegarderInstitution->setText(QApplication::translate("ficheInstitution", "Sauvegarder"));
